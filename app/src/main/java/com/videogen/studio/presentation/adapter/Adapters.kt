package com.videogen.studio.presentation.adapter
...
import com.videogen.databinding.ItemBatchBinding
import com.videogen.databinding.ItemGeneratedVideoBinding
...
import com.videogen.studio.util.toFormattedDate
import com.videogen.studio.util.toFormattedDuration
import java.io.File
...
class VideoBatchAdapter(
    ...
    inner class ViewHolder(private val binding: ItemBatchBinding) :
        ...
        fun bind(item: VideoBatchItem) {
            ...
            binding.ivBatchIcon.setImageResource(com.videogen.R.drawable.ic_video_batch)
...
class ImageBatchAdapter(
    ...
    inner class ViewHolder(private val binding: ItemBatchBinding) :
        ...
        fun bind(item: ImageBatchItem) {
            ...
            binding.tvCreatedAt.text = item.createdAt.toFormattedDate()
            binding.ivBatchIcon.setImageResource(com.videogen.R.drawable.ic_image_batch)
            binding.btnDelete.setOnClickListener { onDelete(item) }
        }
    }
...
class GeneratedVideoAdapter(
    ...
    inner class ViewHolder(private val binding: ItemGeneratedVideoBinding) :
        ...
        fun bind(item: GeneratedVideo) {
            ...
            binding.tvMissing.visibility = if (exists) View.GONE else View.VISIBLE

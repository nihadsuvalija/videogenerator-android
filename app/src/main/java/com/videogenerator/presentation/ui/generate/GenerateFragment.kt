...
import com.videogenerator.databinding.FragmentGenerateBinding
...
class GenerateFragment : Fragment() {
    ...
    private fun setupDropdowns() {
        ...
        binding.spinnerText.adapter = ArrayAdapter(
            requireContext(), android.R.layout.simple_spinner_item, textOptions
        ).also { it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item) }

        // Font
        val fontOptions = FontOption.values().map { it.displayName }
        binding.spinnerFont.adapter = ArrayAdapter(
            requireContext(), android.R.layout.simple_spinner_item, fontOptions
        ).also { it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item) }

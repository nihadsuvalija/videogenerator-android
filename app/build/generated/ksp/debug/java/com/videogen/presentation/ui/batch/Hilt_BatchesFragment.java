...
import com.videogen.studio.presentation.ui.batch.BatchesFragment;
...
public abstract class Hilt_BatchesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BatchesFragment() {
    super();
  }

  Hilt_BatchesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BatchesFragment_GeneratedInjector) this.generatedComponent()).injectBatchesFragment(UnsafeCasts.<BatchesFragment>unsafeCast(this));
    }
  }

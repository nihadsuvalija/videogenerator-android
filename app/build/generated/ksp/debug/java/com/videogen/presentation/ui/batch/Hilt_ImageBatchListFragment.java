...
import com.videogen.studio.presentation.ui.batch.ImageBatchListFragment;
...
public abstract class Hilt_ImageBatchListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageBatchListFragment() {
    super();
  }

  Hilt_ImageBatchListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageBatchListFragment_GeneratedInjector) this.generatedComponent()).injectImageBatchListFragment(UnsafeCasts.<ImageBatchListFragment>unsafeCast(this));
    }
  }

package com.videogen.presentation.ui.batch;
...
import com.videogen.studio.presentation.ui.batch.VideoBatchListFragment;
...
public abstract class Hilt_VideoBatchListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoBatchListFragment() {
    super();
  }

  Hilt_VideoBatchListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoBatchListFragment_GeneratedInjector) this.generatedComponent()).injectVideoBatchListFragment(UnsafeCasts.<VideoBatchListFragment>unsafeCast(this));
    }
  }

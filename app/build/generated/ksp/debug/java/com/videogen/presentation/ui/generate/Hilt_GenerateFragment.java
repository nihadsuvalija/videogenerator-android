package com.videogen.presentation.ui.generate;
...
import com.videogen.studio.presentation.ui.generate.GenerateFragment;
...
public abstract class Hilt_GenerateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GenerateFragment() {
    super();
  }

  Hilt_GenerateFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GenerateFragment_GeneratedInjector) this.generatedComponent()).injectGenerateFragment(UnsafeCasts.<GenerateFragment>unsafeCast(this));
    }
  }

package com.videogen.presentation.ui.history;
...
import com.videogen.studio.presentation.ui.history.HistoryFragment;
...
public abstract class Hilt_HistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HistoryFragment_GeneratedInjector) this.generatedComponent()).injectHistoryFragment(UnsafeCasts.<HistoryFragment>unsafeCast(this));
    }
  }
